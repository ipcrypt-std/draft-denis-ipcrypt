...
def verify_ndx_vectors():
    ...
    # Test vector 1
    key = binascii.unhexlify("0123456789abcdeffedcba98765432101032547698badcfeefcdab8967452301")
    ip = "0.0.0.0"
    ...
    # Test vector 2
    key = binascii.unhexlify("1032547698badcfeefcdab89674523010123456789abcdeffedcba9876543210")
    ip = "192.0.2.1"
    ...
    # Test vector 3
    key = binascii.unhexlify("2b7e151628aed2a6abf7158809cf4f3c3c4fcf098815f7aba6d2ae2816157e2b")
    ip = "2001:db8::1"
    tweak = binascii.unhexlify("21bd1834bc088cd2b4ecbe30b70898d7")
